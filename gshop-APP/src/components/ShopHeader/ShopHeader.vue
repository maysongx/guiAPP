<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:`url(${info.bgImg})`}">
      <a class="back" @click="$router.back()"><i class="iconfont iconjiantou-zuo"></i></a>
    </nav>
    ...
    <!--获取第一个优惠/折扣-->
    <div class="shop-header-discounts" @click="toggleSupportsShow" v-if="info.supports">
      <div class="discounts-left">
        <div class="activity" :class="activityClass[info.supports[0].type]">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-if="supportsShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li v-for="(support,index) in info.supports" :key="index" class="activity-item"
        ...
        <div class="activity-sheet-cover" @click="toggleSupportsShow"></div>
      </div>
    </transition>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      supportsShow: false,  //全部的折扣列表
      shopShow: false,//商店信息介绍
    }
  },
  computed: {
    ...mapState('Shop', {
  ...
  methods: {
    ...mapActions('Shop', ['getShopInfoList']),
    // 切换全部折扣/优惠列表
    toggleSupportsShow() {
